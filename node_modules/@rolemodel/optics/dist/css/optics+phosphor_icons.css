...
@import 'https://unpkg.com/@phosphor-icons/web@2.1.2/src/regular/style.css';
@import 'https://unpkg.com/@phosphor-icons/web@2.1.2/src/thin/style.css';
@import 'https://unpkg.com/@phosphor-icons/web@2.1.2/src/light/style.css';
@import 'https://unpkg.com/@phosphor-icons/web@2.1.2/src/bold/style.css';
@import 'https://unpkg.com/@phosphor-icons/web@2.1.2/src/fill/style.css';
@import 'https://unpkg.com/@phosphor-icons/web@2.1.2/src/duotone/style.css';
/* Third party Vendors */
/* Box sizing rules */
*,
*::before,
...
/*
  ...
  See Changelog at: https://github.com/phosphor-icons/web/releases
